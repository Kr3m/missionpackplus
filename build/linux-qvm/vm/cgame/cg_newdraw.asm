...
line 614
;612:
;613:// FIXME: team name support
;614:static void CG_DrawRedName(rectDef_t *rect, float scale, vec4_t color, int textStyle ) {
line 615
;615:  CG_Text_Paint(rect->x, rect->y + rect->h, scale, color, cg_redTeamName.string , 0, 0, textStyle);
ADDRLP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
line 619
;619:  CG_Text_Paint(rect->x, rect->y + rect->h, scale, color, cg_blueTeamName.string, 0, 0, textStyle);
ADDRLP4 0
ADDRFP4 0
INDIRP4
ASGNP4
