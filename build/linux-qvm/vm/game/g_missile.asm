...
;745:=================
;746:*/
;747:#define NAILGUN_SPREAD	500
;748:
;749:gentity_t *fire_nail( gentity_t *self, vec3_t start, vec3_t forward, vec3_t right, vec3_t up ) {
line 755
;750:	gentity_t	*bolt;
;751:	vec3_t		dir;
;752:	vec3_t		end;
...
ASGNP4
line 757
;757:	bolt->nextthink = level.time + 10000;
ADDRLP4 0
INDIRP4
CNSTI4 688
ADDP4
...
ASGNI4
line 758
;758:	bolt->think = G_ExplodeMissile;
ADDRLP4 0
INDIRP4
CNSTI4 692
ADDP4
...
ASGNI4
line 760
;760:	bolt->r.svFlags = SVF_USE_CURRENT_ORIGIN;
ADDRLP4 0
INDIRP4
CNSTI4 424
ADDP4
...
ASGNI4
line 765
;765:	bolt->methodOfDeath = MOD_NAIL;
ADDRLP4 0
INDIRP4
CNSTI4 752
ADDP4
...
;768:
;769:	// missile owner
;770:	bolt->s.clientNum = self->s.clientNum;
ADDRLP4 0
INDIRP4
CNSTI4 168
ADDP4
...
line 772
;771:	// unlagged
;772:	bolt->s.otherEntityNum = self->s.number;
ADDRLP4 0
INDIRP4
CNSTI4 140
ADDP4
...
line 774
;773:
;774:	bolt->s.pos.trType = TR_LINEAR;
ADDRLP4 0
INDIRP4
CNSTI4 12
ADDP4
...
ASGNI4
line 775
;775:	bolt->s.pos.trTime = level.time;
ADDRLP4 0
INDIRP4
CNSTI4 16
ADDP4
...
ASGNI4
line 776
;776:	VectorCopy( start, bolt->s.pos.trBase );
ADDRLP4 0
INDIRP4
CNSTI4 24
ADDP4
...
ASGNF4
line 779
;779:	u = sin(r) * crandom() * NAILGUN_SPREAD * 16;
ADDRLP4 28
INDIRF4
ARGF4
ADDRLP4 48
...
ASGNF4
line 780
;780:	r = cos(r) * crandom() * NAILGUN_SPREAD * 16;
ADDRLP4 28
INDIRF4
ARGF4
ADDRLP4 56
...
ASGNF4
line 781
;781:	VectorMA( start, 8192 * 16, forward, end);
ADDRLP4 64
ADDRFP4 4
INDIRP4
ASGNP4
...
ASGNF4
line 784
;784:	VectorSubtract( end, start, dir );
ADDRLP4 88
ADDRFP4 4
INDIRP4
ASGNP4
...
ASGNF4
line 788
;788:	VectorScale( dir, scale, bolt->s.pos.trDelta );
ADDRLP4 0
INDIRP4
CNSTI4 36
ADDP4
...
ASGNF4
line 789
;789:	SnapVector( bolt->s.pos.trDelta );
ADDRLP4 0
INDIRP4
CNSTI4 36
ADDP4
...
line 791
;790:
;791:	VectorCopy( start, bolt->r.currentOrigin );
ADDRLP4 0
INDIRP4
CNSTI4 488
ADDP4
...
;800:=================
;801:*/
;802:gentity_t *fire_prox( gentity_t *self, vec3_t start, vec3_t dir ) {
line 805
;803:	gentity_t	*bolt;
;804:
...
ASGNP4
line 809
;809:	bolt->nextthink = level.time + 3000;
ADDRLP4 0
INDIRP4
CNSTI4 688
ADDP4
...
ASGNI4
line 810
;810:	bolt->think = G_ExplodeMissile;
ADDRLP4 0
INDIRP4
CNSTI4 692
ADDP4
...
ASGNI4
line 812
;812:	bolt->r.svFlags = SVF_USE_CURRENT_ORIGIN;
ADDRLP4 0
INDIRP4
CNSTI4 424
ADDP4
...
ASGNI4
line 813
;813:	bolt->s.weapon = WP_PROX_LAUNCHER;
ADDRLP4 0
INDIRP4
CNSTI4 192
ADDP4
...
ASGNI4
line 815
;815:	bolt->r.ownerNum = self->s.number;
ADDRLP4 0
INDIRP4
CNSTI4 512
ADDP4
...
ASGNI4
line 820
;820:	bolt->methodOfDeath = MOD_PROXIMITY_MINE;
ADDRLP4 0
INDIRP4
CNSTI4 752
ADDP4
...
ASGNI4
line 821
;821:	bolt->splashMethodOfDeath = MOD_PROXIMITY_MINE;
ADDRLP4 0
INDIRP4
CNSTI4 756
ADDP4
...
line 825
;824:
;825:	if ( self->s.powerups & (1 << PW_QUAD) )
ADDRFP4 0
INDIRP4
CNSTI4 188
ADDP4
...
;827:
;828:	// missile owner
;829:	bolt->s.clientNum = self->s.clientNum;
ADDRLP4 0
INDIRP4
CNSTI4 168
ADDP4
...
line 835
;832:
;833:	// count is used to check if the prox mine left the player bbox
;834:	// if count == 1 then the prox mine left the player bbox and can attack to it
;835:	bolt->count = 0;
ADDRLP4 0
INDIRP4
CNSTI4 760
...
line 838
;836:
;837:	//FIXME: we prolly wanna abuse another field
;838:	bolt->s.generic1 = self->client->sess.sessionTeam;
ADDRLP4 0
INDIRP4
CNSTI4 204
ADDP4
...
line 840
;839:
;840:	bolt->s.pos.trType = TR_GRAVITY;
ADDRLP4 0
INDIRP4
CNSTI4 12
ADDP4
...
ASGNB 12
line 843
;843:	VectorScale( dir, 700, bolt->s.pos.trDelta );
ADDRLP4 0
INDIRP4
CNSTI4 36
ADDP4
