...
// bitmask: 0 = off, 1 = hitscan only, 2 = hitscan + projectile
CG_CVAR( cg_delag, "cg_delag", "2", CVAR_USERINFO | CVAR_ARCHIVE )
...
CG_CVAR( cg_ratPredictMissiles, "cg_ratPredictMissiles", "0", CVAR_ARCHIVE )
CG_CVAR( cg_predictExplosions, "cg_predictExplosions", "1", CVAR_ARCHIVE )
CG_CVAR( cg_delagProjectileTrail, "cg_delagProjectileTrail", "0", CVAR_ARCHIVE )
