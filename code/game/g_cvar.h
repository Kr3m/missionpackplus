...
G_CVAR( pmove_AirAccel,                         "pmove_AirAccel",                         "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_AirControl,                       "pmove_AirControl",                       "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_AirStepFriction,                  "pmove_AirStepFriction",                  "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_AirSteps,                         "pmove_AirSteps",                         "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_AirStopAccel,                     "pmove_AirStopAccel",                     "", CVAR_SERVERINFO, 0, qfalse, qfalse )
...
G_CVAR( pmove_ChainJumpVelocity,                "pmove_ChainJumpVelocity",                "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_CircleStrafeFriction,             "pmove_CircleStrafeFriction",             "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_CrouchSlide,                      "pmove_CrouchSlide",                      "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_CrouchSlideFriction,              "pmove_CrouchSlideFriction",              "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_CrouchSlideTime,                  "pmove_CrouchSlideTime",                  "", CVAR_SERVERINFO, 0, qfalse, qfalse )
...
G_CVAR( pmove_JumpTimeDeltaMin,                 "pmove_JumpTimeDeltaMin",                 "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocity,                     "pmove_JumpVelocity",                     "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocityMax,                  "pmove_JumpVelocityMax",                  "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocityScaleAdd,             "pmove_JumpVelocityScaleAdd",             "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocityTimeThreshold,        "pmove_JumpVelocityTimeThreshold",        "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocityTimeThresholdOffset,  "pmove_JumpVelocityTimeThresholdOffset",  "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_RampJump,                         "pmove_RampJump",                         "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_RampJumpScale,                    "pmove_RampJumpScale",                    "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_StepHeight,                       "pmove_StepHeight",                       "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_StepJump,                         "pmove_StepJump",                         "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_StepJumpVelocity,                 "pmove_StepJumpVelocity",                 "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_StrafeAccel,                      "pmove_StrafeAccel",                      "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_Velocity_gh,                      "pmove_Velocity_gh",                      "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_WalkAccel,                        "pmove_WalkAccel",                        "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_WalkFriction,                     "pmove_WalkFriction",                     "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_WaterSwimScale,                   "pmove_WaterSwimScale",                   "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_WaterWadeScale,                   "pmove_WaterWadeScale",                   "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_WishSpeed,                        "pmove_WishSpeed",                        "", CVAR_SERVERINFO, 0, qfalse, qfalse )
