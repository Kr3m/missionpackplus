...
G_CVAR( pmove_AirControl,                       "pmove_AirControl",                       "", CVAR_SERVERINFO, 0, qfalse, qfalse )
...
G_CVAR( pmove_AutoHop,                          "pmove_AutoHop",                          "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_BunnyHop,                         "pmove_BunnyHop",                         "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_ChainJump,                        "pmove_ChainJump",                        "", CVAR_SERVERINFO, 0, qfalse, qfalse )
...
G_CVAR( pmove_CrouchSlide,                      "pmove_CrouchSlide",                      "", CVAR_SERVERINFO, 0, qfalse, qfalse )
...
G_CVAR( pmove_CrouchStepJump,                   "pmove_CrouchStepJump",                   "", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_DoubleJump,                       "pmove_DoubleJump",                       "", CVAR_SERVERINFO, 0, qfalse, qfalse )
...
G_CVAR( pmove_RampJump,                         "pmove_RampJump",                         "", CVAR_SERVERINFO, 0, qfalse, qfalse )
...
G_CVAR( pmove_StepJump,                         "pmove_StepJump",                         "", CVAR_SERVERINFO, 0, qfalse, qfalse )
...
G_CVAR( pmove_noPlayerClip,                     "pmove_noPlayerClip",                     "", CVAR_SERVERINFO, 0, qfalse, qfalse )
