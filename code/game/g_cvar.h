...
G_CVAR( g_delagMissileImmediateRun, "g_delagMissileImmediateRun", "2", CVAR_ARCHIVE, 0, qfalse, qfalse )
...
G_CVAR( g_allowKill, "g_allowKill", "1", CVAR_ARCHIVE, 0, qtrue,qtrue )
...
G_CVAR( g_runes, "g_runes", "1", CVAR_LATCH, 0, qfalse, qfalse )
...
// Any cvar with a non-empty value overrides its corresponding phy_* variable
// for ALL connected clients, regardless of g_moveType.
// Server-side only: clients have no control over these settings.
G_CVAR( pmove_AirAccel,                         "pmove_AirAccel",                         "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_AirControl,                       "pmove_AirControl",                       "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_AirStepFriction,                  "pmove_AirStepFriction",                  "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_AirSteps,                         "pmove_AirSteps",                         "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_AirStopAccel,                     "pmove_AirStopAccel",                     "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_AutoHop,                          "pmove_AutoHop",                          "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_BunnyHop,                         "pmove_BunnyHop",                         "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_ChainJump,                        "pmove_ChainJump",                        "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_ChainJumpVelocity,                "pmove_ChainJumpVelocity",                "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_CircleStrafeFriction,             "pmove_CircleStrafeFriction",             "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_CrouchSlide,                      "pmove_CrouchSlide",                      "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_CrouchSlideFriction,              "pmove_CrouchSlideFriction",              "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_CrouchSlideTime,                  "pmove_CrouchSlideTime",                  "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_CrouchStepJump,                   "pmove_CrouchStepJump",                   "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_DoubleJump,                       "pmove_DoubleJump",                       "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_JumpTimeDeltaMin,                 "pmove_JumpTimeDeltaMin",                 "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocity,                     "pmove_JumpVelocity",                     "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocityMax,                  "pmove_JumpVelocityMax",                  "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocityScaleAdd,             "pmove_JumpVelocityScaleAdd",             "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocityTimeThreshold,        "pmove_JumpVelocityTimeThreshold",        "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_JumpVelocityTimeThresholdOffset,  "pmove_JumpVelocityTimeThresholdOffset",  "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_RampJump,                         "pmove_RampJump",                         "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_RampJumpScale,                    "pmove_RampJumpScale",                    "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_StepHeight,                       "pmove_StepHeight",                       "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_StepJump,                         "pmove_StepJump",                         "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_StepJumpVelocity,                 "pmove_StepJumpVelocity",                 "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_StrafeAccel,                      "pmove_StrafeAccel",                      "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_Velocity_gh,                      "pmove_Velocity_gh",                      "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_WalkAccel,                        "pmove_WalkAccel",                        "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_WalkFriction,                     "pmove_WalkFriction",                     "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_WaterSwimScale,                   "pmove_WaterSwimScale",                   "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_WaterWadeScale,                   "pmove_WaterWadeScale",                   "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_WishSpeed,                        "pmove_WishSpeed",                        "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( pmove_noPlayerClip,                     "pmove_noPlayerClip",                     "-1", CVAR_SERVERINFO, 0, qfalse, qfalse )
